-- SIMPLE DATABASE RESET - This will fix the "Database error saving new user" issue
-- Run this in Supabase SQL Editor (compatible with Supabase syntax)
...
-- 2. Try to remove posts from realtime publication (ignore errors)
